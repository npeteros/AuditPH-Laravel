...
const Create = ({ auth }) => {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('budgets.store'), { onSuccess: () => reset() });
    }
                ...
                <form onSubmit={submit}>
                    <div className="bg-white dark:bg-neutral-700 rounded-lg p-4">
                        ...
                        <div className="mx-6">
                            ...
                            <label for="budget_total" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Set a budget</label>
